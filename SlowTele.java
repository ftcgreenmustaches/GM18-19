 ...
 */
@TeleOp(name = "SlowTele", group = "FTCRed")
public class SlowTele extends OpMode {
    ...
    public void init() {
        ...
        TMServo= hardwareMap.get(CRServo.class,"TMServo");
    }
    ...
    public void loop() {
        ...
        robot.frontLeftMotor.setPower((leftY_G1 + rightX_G1 + leftX_G1) * 0.35);
        robot.rearLeftMotor.setPower((leftY_G1 + rightX_G1 - leftX_G1) * 0.35);
        robot.rearRightMotor.setPower((leftY_G1 - rightX_G1 + leftX_G1) * 0.35);
        robot.frontRightMotor.setPower((leftY_G1 - rightX_G1 - leftX_G1) * 0.35);
