...
@Autonomous(name = "CraterHelper", group = "Linear Opmode")
public class Craterhelper extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() && firsttime == 1) {
            ...
            for (int i = 0; i < 31 && !isStopRequested(); ++i) {
                sleep(100);
                idle();
            }
            ...
            if (MineralPosition == 1) {
                ...
                setDriveSpeed(-0.45, -0.5, 0, 0);
                sleep(1000);

                setDriveSpeed(-0.55, -0.50, 0, 0);
                sleep(1300);
