...
@Autonomous(name = "DetectorTest", group = "Linear Opmode")
public class DetectorTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() && firsttime == 1) {
            ...
            telemetry.addData("center",sensorColor.red());
            telemetry.update();
            }
            else {
                detector.alignPosOffset=250 ;
            if (detector.getAligned()){
                telemetry.addData("right",sensorColor.red());
                telemetry.update();
            }else {
                telemetry.addData("left",sensorColor.red());
                telemetry.update();
            }
            }
