...
public class Tele extends OpMode {
    ...
    public void loop() {
        ...
        if (gamepad2.left_stick_button) {
            ...
            //AUTON
//            robot.rearLeftMotor.setPower((leftY_G1 + rightX_G1 - leftX_G1 * 0.75) * 0.6);
//            robot.rearRightMotor.setPower((leftY_G1 - rightX_G1 + leftX_G1 * 0.75) * 0.6);
            if (gamepad1.left_bumper || gamepad1.right_bumper) {
                if (leftX_G1>0) {//LEFT
                    robot.frontLeftMotor.setPower(leftX_G1*1);//1
                    robot.rearLeftMotor.setPower(-leftX_G1*1.25);//1.25
                    robot.rearRightMotor.setPower(leftX_G1*1);//1
                    robot.frontRightMotor.setPower(-leftX_G1*.5);//.5
                }else {//RIGHT
                    robot.frontLeftMotor.setPower(leftX_G1*0.5);//.5
                    robot.rearLeftMotor.setPower(-leftX_G1*1);//1
                    robot.rearRightMotor.setPower(leftX_G1*1.25);//1.25
                    robot.frontRightMotor.setPower(-leftX_G1*1);//1
                }
            } else {
                robot.frontLeftMotor.setPower(leftY_G1 * 0.6 + rightX_G1 * 0.8);
                robot.rearLeftMotor.setPower(leftY_G1*0.6 + rightX_G1 * 0.8);
                robot.rearRightMotor.setPower(leftY_G1*0.6 - rightX_G1 * 0.8);
                robot.frontRightMotor.setPower(leftY_G1 * .6 - rightX_G1 * 0.8);
            }
