...
//            robot.rearRightMotor.setPower((leftY_G1 - rightX_G1 + leftX_G1 * 0.75) * 0.6);
            if (gamepad1.left_bumper || gamepad1.right_bumper) {
                if (leftX_G1>0) {//LEFT
                    robot.frontLeftMotor.setPower(leftX_G1*1);
                    robot.rearLeftMotor.setPower(-leftX_G1*1.25);
                    robot.rearRightMotor.setPower(leftX_G1*1);
                    robot.frontRightMotor.setPower(-leftX_G1*.5);
                }else {//RIGHT
                    robot.frontLeftMotor.setPower(leftX_G1*0.5);
                    robot.rearLeftMotor.setPower(-leftX_G1*1);
                    robot.rearRightMotor.setPower(leftX_G1*1.25);
                    robot.frontRightMotor.setPower(-leftX_G1*1);
                }
            } else {
