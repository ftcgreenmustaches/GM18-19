...
@Autonomous(name = "MAINDEPOT", group = "Linear Opmode")
public class MAINDEPOT extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() && firsttime == 1) {
            ...
            while (Math.abs(getHeading() + -4) > HEADING_EPSILON) {
            ...
            if (detector.isFound()) {
                ...
                while (Math.abs(getHeading() - 95) > HEADING_EPSILON) {
...
sleep(1000);
                ...
                while (Math.abs(getHeading() + 33) > HEADING_EPSILON) {
                    setDriveSpeed(0.4, -0.4, 0.4, -0.4);
                }
                ...
                if (detector.isFound()) {
                    ...
                    while (Math.abs(getHeading() + -29) > HEADING_EPSILON) {
                        setDriveSpeed(-0.45, 0.45, -0.45, 0.45);
                    }
                    ...
                    while (Math.abs(getHeading() - 78) > HEADING_EPSILON) {
                        setDriveSpeed(-0.4, 0.4, -0.4, 0.4);
                    ...
                    while (Math.abs(getHeading() + 120) > HEADING_EPSILON) {
                        setDriveSpeed(0.4, -0.4, 0.4, -0.4);

                    }

                    setDriveSpeed(0.4, 0.5, 0, 0);
                    sleep(8000);
